...
var VideoPlayer = function (props) {
    ...
    var videoObj = props.videoObj, showChannel = props.showChannel, updateVideoUrl = props.updateVideoUrl, removeVideo = props.removeVideo, showChannelSelect = props.showChannelSelect;
    useEffect(function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (!(videoObj && videoObj.code)) return [3 /*break*/, 2];
