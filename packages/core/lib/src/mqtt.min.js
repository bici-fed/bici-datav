...
!function (e) { if ("object" == typeof exports && "undefined" != typeof module)
    ...
    i(n[s]); return i; }; }()({ 1: [function (e, t, r) { (function (r, n) {
        ...
        } return s.namespace = e, s.enabled = n.enabled(e), s.useColors = n.useColors(), s.color = r(e), s.destroy = i, s.extend = o, "function" == typeof n.init && n.init(s), n.instances.push(s), s; } function i() { var e = n.instances.indexOf(this); return -1 !== e && (n.instances.splice(e, 1), !0); } function o(e, t) { var r = n(this.namespace + (void 0 === t ? ":" : t) + e); return r.log = this.log, r; } function s(e) { return e.toString().substring(2, e.toString().length - 2).replace(/\.\*\?$/, "*"); } return n.debug = n, n.default = n, n.coerce = function (e) { return e instanceof Error ? e.stack || e.message : e; }, n.disable = function () { var e = __spreadArray(__spreadArray([], n.names.map(s), true), n.skips.map(s).map(function (e) { return "-" + e; }), true).join(","); return n.enable(""), e; }, n.enable = function (e) { var t; n.save(e), n.names = [], n.skips = []; var r = ("string" == typeof e ? e : "").split(/[\s,]+/), i = r.length; for (t = 0; t < i; t++)
